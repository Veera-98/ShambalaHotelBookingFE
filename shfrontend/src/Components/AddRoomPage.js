...
export function AddRoomPage() {
  ...
  const handleChange = (e) => {
    ...
    setRoomDetails((prevState) => ({
      ...prevState,
      [name]: value,
      price: value === "King" ? "100.00" : value === "Queen" ? "120.00" : value === "Suite-King" ? "130.00" : value === "Suite-Queen" ? "140.00" : prevState.price,
      capacity: value === "King" || value === "Suite-King" ? "3" : value === "Queen" || value === "Suite-Queen" ? "4" : prevState.capacity,
      roomNo: name === "roomNo" ? value : "" // Ensures roomNo can be updated
    }));
  };
    ...
    <div className="add-room-page" style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      <nav className="sidebar">
        <ul className="sidebar-list">
          ...
          <li className="sidebar-item large-link-box">
            <NavLink className="sidebar-link large-link-box" to="/Billsandivoice">Bills and Invoice</NavLink>
          </li>
       </ul>
      </nav>
