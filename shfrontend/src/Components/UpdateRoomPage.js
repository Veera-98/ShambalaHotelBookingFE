...
function UpdateRoomPage() {
  ...
  return (
    <div>
      <Sidebar />
      <div>
        <h1 style={{ width: '100%', textAlign: 'center', fontSize: '50px', marginBottom: '10px' }}>Update Room</h1>
      </div>
      <div className="update-room-page" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '60vh', flexDirection: 'column' }}>
        <div className="form-box" style={{ width: 'fit-content', padding: '20px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)', borderRadius: '5px', marginTop: '10px' }}>
